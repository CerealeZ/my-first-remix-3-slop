...
For a human-oriented guide to the starter, see:

- [docs/README.md](./docs/README.md)
- [docs/primeros-pasos.md](./docs/primeros-pasos.md)
- [docs/capacidades-del-framework.md](./docs/capacidades-del-framework.md)
- [docs/guia-de-trabajo.md](./docs/guia-de-trabajo.md)
